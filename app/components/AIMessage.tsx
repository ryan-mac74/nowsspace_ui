...
// Sub-component for code copy and language header
function CodeBlock({
    language, children
}: {
    ...
    return (
        <div className="my-4 rounded-xl overflow-hidden border border-zinc-800 bg-zinc-950 text-zinc-200 font-mono text-sm shadow-md">
            {/* Code Bar */}
            <div className="flex items-center justify-between px-4 py-2 bg-zinc-900/90 border-b border-zinc-800/80 text-xs text-zinc-400">
                ...
                <button
                    type="button"
                    onClick={handleCopy}
                    className="flex items-center gap-1.5 hover:text-zinc-100 transition-colors text-zinc-400"
                >
                    {copied ? (
                        <>
